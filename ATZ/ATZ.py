...
class ATZ:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ATZ', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ATZ/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def select_input_folder(self):
        ...
        dialog = QFileDialog()
        folder_path = dialog.getExistingDirectory(self.dlg, "Select Folder", "")
        self.dlg.Proj_Folder.setText(folder_path)
        return folder_path
    ...
    def run(self):
        ...
        progressMessageBar = iface.messageBar().createMessage("Creating ATZ Maps...")
